...
CREATE TABLE FC_CUMT_ADMN_USER
(
	FC_CUMT_MAST_SEQ bigint(20) NOT NULL,
	FC_BOARD_ID bigint(20) NOT NULL,
	-- M : 마스터
	-- B : 부마스터
	CUMT_MAST_YN char(1) DEFAULT 'M' NOT NULL COMMENT 'M : 마스터
B : 부마스터',
	-- C : 커뮤니티
	-- B : 커뮤니티 게시판
	CUMT_BOARD_YN varchar(2) DEFAULT 'C' COMMENT 'C : 커뮤니티
B : 커뮤니티 게시판',
	COMP_ID char(3) NOT NULL,
	USER_ID varchar(20) NOT NULL,
	DEPT_ID char(4) NOT NULL,
	PRIMARY KEY (FC_CUMT_MAST_SEQ)
);
...
(
	FC_BOARD_ID bigint(20) NOT NULL,
	COMP_ID char(3) NOT NULL,
	FC_USER_ID varchar(20) NOT NULL,
	DEPT_ID char(4) NOT NULL,
	-- C : 커뮤니티
	-- B : 게시판
...
ALTER TABLE FC_CUMT_ADD_INFO
	ADD FOREIGN KEY (FC_BOARD_ID)
	REFERENCES FC_CUMT_INFO (FC_BOARD_ID)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
;
